...
const rulesData = {
    ...
    puzzle: `
        <h3>🎯 游戏目标</h3>
        <p>将打乱的拼图块通过滑动恢复到原始顺序！每次只能移动与空白格相邻的方块。</p>
        <h3>🎮 操作方式</h3>
        <ul>
        ...
        <h3>🎨 可选主题</h3>
        <ul>
            <li><b>🌄 自然</b>：森林、海洋、天空等自然风光配色</li>
            <li><b>🌃 城市</b>：摩天大楼、霓虹灯光的都市风格</li>
            <li><b>🐾 动物</b>：可爱动物元素搭配暖色调</li>
            <li><b>🍕 美食</b>：缤纷美食主题的鲜艳配色</li>
            <li><b>🎨 抽象</b>：几何图形与撞色搭配的现代风格</li>
        </ul>
        <h3>⭐ 难度等级</h3>
        <ul>
        ...
        <h3>💡 技巧</h3>
        <p>可以点击"预览"按钮查看完整图案。从左上角开始逐行还原是最常用的策略。步数越少评级越高！按 P 键可快速预览完整图片。</p>
    `,
    sliding: `
        <h3>🎯 游戏目标</h3>
        <p>将打乱的拼图块通过滑动恢复到原始顺序！每次只能移动与空白格相邻的方块。</p>
